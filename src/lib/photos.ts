export const photos = {
  ...
  sobre: {
    ...
    className:
      "object-contain object-top sm:object-cover sm:object-[75%_center]",
  },
  homeSobre: {
  ...
  blog: {
    src: "/photos/hero-blog-leitura.jpg",
    alt: "Laís Baroni lendo no consultório",
    className:
      "object-contain object-top sm:object-cover sm:object-[80%_center]",
    unoptimized: true,
  },
  avaliacao: {
    ...
    alt: "Laís Baroni no consultório",
    className:
      "object-contain object-top sm:object-cover sm:object-[78%_center]",
    unoptimized: true,
  },
  infantil: {
    ...
    className:
      "object-contain object-top sm:object-cover sm:object-[70%_center]",
  },
  psicoterapia: {
